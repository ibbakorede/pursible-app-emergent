...
const TAB_ROUTES = [
  ...
  '/wallet/receive', '/withdraw', '/bank-accounts',
...
export default function UserLayout() {
  ...
  // Hide bottom nav for focused flows like KYC
  const hideBottomNav = location.pathname === '/kyc';
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <motion.main 
        className={`flex-1 ${hideBottomNav ? 'pb-6' : 'pb-20'} max-w-lg mx-auto w-full`}
